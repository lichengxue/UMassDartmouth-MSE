...
setwd('C:/Users/swulfing/Documents/GitHub/UMassDartmouth-MSE')
library(wham)
# devtools::document("whamMSE")
# devtools::load_all("whamMSE")
# devtools::install("whamMSE", dependencies = FALSE)
# devtools::install_github("swulfing/whamMSE", dependencies=FALSE)
...
setup_om_input <- function(base_om, hist_dat, ecov_dat) {
  ...
  om_input$data$agg_index_sigma[1:50, ] <- input_hist$data$agg_index_sigma[1:50, ]
  om_input$data$use_indices[1:50, ] <- input_hist$data$use_indices[1:50, ]
  om_input$data$use_index_paa[1:50, ] <- input_hist$data$use_index_paa[1:50, ]
