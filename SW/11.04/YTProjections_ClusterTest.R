...
# setwd(wd)
# 
# PlotLocations <- 'C:/Users/swulfing/Documents/GitHub/UMassD/YT_proj/Manuscripts/Plots/Projections'
# ModelLocations <- 'C:/Users/swulfing/Documents/MSE_results/Projections'
...
ecov_TermYear$mean[51:101,] <- ecov_om_P$mean[50,]
...
EMtempPlot <- ggplot(data.frame(ecov_om), aes(x = year, y = mean)) +
  ...
  geom_line(aes(color = "OM")) +
  scale_color_manual(name='Model',
                     breaks=c('OM', 'AR1', 'RecWind', 'HistAvg', 'RecTrend', 'TermYear'),
                     values=c('OM'="#000000", 
                              'AR1'="#CD0BBC",
                              'RecWind' = "#F5C710" ,
                              'HistAvg' =  "#3283FE",
...
plot_mse_output(mods,
                ...
                col.opt = "D",
                new_model_names = c("Mod_AR1Ecov", "Mod_HistAvgEcov", "Mod_RecWindEcov", "Mod_RecTrendEcov", "Mod_TermYear", "Mod_NoEcov"),
